...
import TreadsNavReader from "../../../nav/treadsNavReader/TreadsNavReader";
...
import styles from "./CreateModalNav.module.css";

const CreateModalNav = ({ active, setActive, section }) => {
